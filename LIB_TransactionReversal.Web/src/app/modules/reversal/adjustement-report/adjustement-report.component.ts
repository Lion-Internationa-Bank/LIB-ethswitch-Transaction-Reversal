...
@Component({
  selector: 'app-adjustement-report',
  templateUrl: './adjustement-report.component.html',
  styleUrls: ['./adjustement-report.component.css']
})
export class AdjustementReportComponent  implements AfterViewInit{
  displayedColumns: string[] = ['accountNumber', 'amount', 'rrn', 'createdAt','approvedBy','approvedDate','paidBy','paymentDate'];
  ...
  searchTransaction(){
    ...
    this.reversalService.getAdjustementReport(params).subscribe(
      res => {
