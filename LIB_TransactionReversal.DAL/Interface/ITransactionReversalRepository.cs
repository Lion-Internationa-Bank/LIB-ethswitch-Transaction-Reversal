...
namespace LIB_Documentmanagement.DAL.Interface
{
    public interface ITransactionReversalRepository
    {
        ...
        Task updateTransactionReversalStatus(int id, string status, string message, string user="", string trasactionId="");
        Task SaveTransactionReversal(List<TransactionReversal> transactionReversalList, TrasactionReversalDbContext context);
